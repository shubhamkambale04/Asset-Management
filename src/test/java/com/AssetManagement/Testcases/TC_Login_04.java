...
public class TC_Login_04 extends BaseClass {

	@DataProvider(name = "emptyUsernamePasswordDataProvider")
	public Object[][] emptyUsernamePasswordDataProvider() {
		return new Object[][] { { "", "", "Super Admin" } };
	}

	@Test(dataProvider = "emptyUsernamePasswordDataProvider")
	public void verifyEmptyUsernamePasswordLogin(String username, String password, String role) {
		...
		if (!username.isEmpty() && !password.isEmpty()) {
			...
			System.out.println("Empty username & Empty password");
		}
